...
class Gags : public Constituent
{
public:
	Gags();
	Gags(double mass, double g_rad, double modulus, double Jdep, double bulkLM);
	Gags(const Gags& other);
	Gags* clone() const override { return new Gags(*this); }
